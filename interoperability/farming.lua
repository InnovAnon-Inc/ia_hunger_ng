...
if ia_util.has_farming_redo() then
  ...
  add('farming:onion_soup',       { satiates = 6, returns = 'farming:bowl' }) -- TODO quenches
  add('farming:pea_pod',          { satiates = 0.6 })
  add('farming:pea_soup',         { satiates = 7, returns = 'farming:bowl' }) -- TODO quenches
